...
namespace DuEDrawingControl
{
    ...
    public class EDrawingView:UserControl
    {
        ...
        private void EDrawingControl_Load(object sender, EventArgs e)
        {
            ...
            Markup = new MarkupComponent(EDrawingHost.CoCreateInstance("EModelViewMarkup.EModelMarkupControl"));
        }
        ...
        private void InitializeComponent()
        {
            ...
            // EDrawingView
            // 
            this.Name = "EDrawingView";
            this.Load += new System.EventHandler(this.EDrawingView_Load);
            this.ResumeLayout(false);

        }
            
        private void EDrawingView_Load(object sender, EventArgs e)
        {
